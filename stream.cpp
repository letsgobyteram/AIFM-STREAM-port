...
int main()
{
        ...
        std::cout << "Array size = " << (unsigned long long) STREAM_ARRAY_SIZE << " (elements), Offset = " << OFFSET << " (elements)\n";
        std::cout << "Memory per array = " << BytesPerWord * ( (double) STREAM_ARRAY_SIZE / 1024.0/1024.0) <<
                " MiB (= " << BytesPerWord * ( (double) STREAM_ARRAY_SIZE / 1024.0/1024.0/1024.0) << " GiB).\n";
        std::cout << "Total memory required = " << (3.0 * BytesPerWord) * ( (double) STREAM_ARRAY_SIZE / 1024.0/1024.) <<
                " MiB (= " << (3.0 * BytesPerWord) * ( (double) STREAM_ARRAY_SIZE / 1024.0/1024./1024.) << " GiB).\n";
        std::cout << "Each kernel will be executed " << NTIMES << " times.\n";
        std::cout << " The *best* time for each kernel (excluding the first iteration)\n";
        std::cout << " will be used to compute the reported bandwidth.\n";
...
void checkSTREAMresults() {
        ...
        bSumErr = 0.0;
        cSumErr = 0.0;
        std::cout << "acumulating sum errors" << std::endl;
        for (j=0; j<STREAM_ARRAY_SIZE; j++)
        {
                aSumErr += abs(a[j] - aj);
                bSumErr += abs(b[j] - bj);
        ...
        std::cout << "end of sum errors" << std::endl;
                        ...
                        if (abs(a[j]/aj-1.0) > epsilon) {
                                ...
                                if (ierr < 10) {
                                        std::cout << "         array a: index: " << j <<
                                                ", expected: " << aj <<
                                                ", observed: " << a[j] <<
                                                ", relative error: " << abs((aj-a[j])/aAvgErr)<< "\n";
                                }
                                #endif
                        }
                }
                        ...
                        if (abs(b[j]/bj-1.0) > epsilon) {
                                ...
                                if (ierr < 10) {
                                        std::cout << "         array b: index: " << j <<
                                                ", expected: " << bj <<
                                                ", observed: " << b[j] <<
                                                ", relative error: " << abs((bj-b[j])/bAvgErr) << "\n";
                                }
                                #endif
                        }
                }
                        ...
                        if (abs(c[j]/cj-1.0) > epsilon) {
                                ...
                                if (ierr < 10) {
                                        std::cout << "         array c: index: " << j <<
                                                ", expected: " << cj <<
                                                ", observed: " << c[j] <<
                                                ", relative error: " << abs(cj-c[j])/cAvgErr << "\n";
                                }
                                #endif
                        }
                }
        ...
        std::cout << "    Observed a(1), b(1), c(1): " << a[j] << " " << b[j] << " " << c[j] << " \n";
