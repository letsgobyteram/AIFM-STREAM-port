...
void _main(void *arg)
{
        ...
        std::unique_ptr<far_memory::FarMemManager> manager =
                std::unique_ptr<far_memory::FarMemManager>(far_memory::FarMemManagerFactory::build(
                        kCacheSize, kNumGCThreads,
                        new far_memory::TCPDevice(raddr, kNumConnections, kFarMemSize)));
        do_work(manager.get());
}
